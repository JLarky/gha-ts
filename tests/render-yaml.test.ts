...
describe("renderWorkflowYaml() golden outputs", () => {
  test("workflow-triggers matches golden (npm:yaml)", () => {
    const yaml = implementations[0].renderWorkflowYaml(buildWorkflowTriggers());
  ...
  test("workflow-triggers matches golden (bun:yaml)", () => {
    const yaml = implementations[1].renderWorkflowYaml(buildWorkflowTriggers());
    expect(yaml).toMatchInlineSnapshot(`
      "# Do not modify!
      # This file was generated by https://github.com/JLarky/gha-ts
  ...
  test("prebuild-actions matches golden (npm:yaml)", () => {
    const yaml = implementations[0].renderWorkflowYaml(buildPrebuildActions());
    expect(yaml).toMatchInlineSnapshot(`
      "# Do not modify!
      # This file was generated by https://github.com/JLarky/gha-ts
  ...
  test("prebuild-actions matches golden (bun:yaml)", () => {
    const yaml = implementations[1].renderWorkflowYaml(buildPrebuildActions());
    expect(yaml).toMatchInlineSnapshot(`
      "# Do not modify!
      # This file was generated by https://github.com/JLarky/gha-ts
  ...
  test("supports custom header via options (npm:yaml)", () => {
    const custom = "## Custom Header\n\n";
    const yaml = implementations[0].renderWorkflowYaml(
  ...
  test("supports custom header via options (bun:yaml)", () => {
    const custom = "## Custom Header\n\n";
    const yaml = implementations[1].renderWorkflowYaml(
      buildWorkflowTriggers(),
      {
        header: custom,
      },
